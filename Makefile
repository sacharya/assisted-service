...
OPENSHIFT_INSTALL_RELEASE_IMAGE := $(or ${OPENSHIFT_INSTALL_RELEASE_IMAGE},quay.io/openshift-release-dev/ocp-release:4.6.1-x86_64)
...
REGISTRY := $(or ${REGISTRY},quay.io)
REGISTRY_AUTH_FILE := $(or ${REGISTRY_AUTH_FILE},"")
